...
- 相关笔记：[面试题目汇总](../../../10-sources/interviews/2026-07-05-面试题目汇总.md) · [操作系统学习讨论记录](../../../00-inbox/2026-07-06-图解系统学习讨论记录.md)。
...
完整 72 条当前有效岗位见：[Agent 当前岗位索引](../02-岗位追踪/岗位索引.md)。索引已把 `事业部/产品线` 与 `实际业务方向` 分开记录；官网未公开更高层组织时不做猜测。
...
1. 每周五 20:00 固定扫描 11 家核心公司，并轮换 6 家观察公司。
