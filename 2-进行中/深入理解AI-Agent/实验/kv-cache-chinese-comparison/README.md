...
```bash
cd /Users/gaoronghui/Documents/agent_learning/2-进行中/深入理解AI-Agent/资料/本地资料/深入理解AI-Agent/ai-agent-book-chapter2-current/chapter2/kv-cache
PYTHONPATH=../.. ../../.venv/bin/python /Users/gaoronghui/Documents/agent_learning/2-进行中/深入理解AI-Agent/实验/kv-cache-chinese-comparison/run_campaign.py
```
